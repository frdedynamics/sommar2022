...
class controller_rowCentration(object):
    def __init__ (self):
        ...
        self.controller_rowFollower_service = rospy.Service("/raspberry_bot/rowCentering/command", SetBool, self.controller_rowFollower_callback) #Subscriber til rowFollower command
