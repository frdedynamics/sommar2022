...
class command_raspberry_bot(object):
	...
	while(True):
		...
		self.rowCentering()
	        ...
	        #Kjorer robot frem til ende av rad
	        bevegelse = "linear"
	        input = 1.0
	        self.move_command(bevegelse, input)
	        ...
	        #Kaller rowCentering servic
		self.rowCentering()

	        #Kjorer robot 5.0 meter tomt felt
	        bevegelse = "linear"
	        input = 4.5
	        self.move_command(bevegelse, input)
		...
		self.rowCentering()
	        ...
	        #Kjorer robot sidelengs av telt
	        bevegelse = "linear"
	        input = 6.2
	        self.move_command(bevegelse, input)
